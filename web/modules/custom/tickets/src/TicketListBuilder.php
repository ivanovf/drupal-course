...
/**
 * Provides a list controller for the ticket entity type.
 */
class TicketListBuilder extends EntityListBuilder {
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total tickets: @total', ['@total' => $total]);
    return $build;
  }
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\tickets\TicketInterface $entity */
    $row['id'] = $entity->id();
